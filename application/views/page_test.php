...
{
	$("#"+str).toggle();
	if($("#button_"+str).val()=='Show')
	{
		$("#button_"+str).val('Hide')
	}
	else
	{
		$("#button_"+str).val('Show')
	}
}
</script>
<div class="container">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr >
                ...
                <td>
                    <input type="button" value="Show" onClick="showFull('<?=$thisid?>')" id="button_<?=$thisid?>" >
                </td>
              </tr>
             ...
             <?php }
              ...
              <tfoot>
                <tr style="background-color:#999">
                    ...
                    <td class="pageSize"><?php echo   round($total_time ,2);?> ms</td>
                </tr>
            </tfoot>
            </tbody>
          </table>
